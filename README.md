...
```bash
sudo apt install -y git && git clone https://github.com/jrchalub/instaladorNovo.git instaladorNovo && sudo chmod -R 777 ./instaladorNovo && cd ./instaladorNovo && sudo ./install_primaria
```
