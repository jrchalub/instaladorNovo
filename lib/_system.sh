...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Zion CRM...${GRAY_LIGHT}"
  printf "\n\n"
...
sudo su - deploy <<EOF
  git clone -b main https://jrchalub:${token_code}@github.com/jrchalub/ZIONFLOW_NOVO.git/home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos preparar o sistema para o Zion CRM...${GRAY_LIGHT}"
  printf "\n\n"
