...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Zion CRM selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Zion CRM\n"
  printf "   [1] Atualizar Zion CRM\n"
  printf "   [2] Deletar Zion CRM\n"
  printf "\n"
  read -p "> " option
